...
namespace SurveyorLedger.Data.Migrations
{
    ...
    [Migration("20260822120557_ReseedPoliciesForOrganizationChain")]
    partial class ReseedPoliciesForOrganizationChain
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SurveyorLedger.Data.Entities.Organization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SurveyorLedger.Data.Entities.OrganizationSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SurveyorLedger.Data.Entities.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Action = "view",
                            CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "View organization details and its workspaces.",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Change the organization's subscription tier.",
                            Name = "organization.manage_subscription",
                            Resource = "organization"
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Create a new workspace under the organization, subject to its tier's workspace limit.",
                            Name = "organization.create_workspace",
                            Resource = "organization"
                        });
                });
            ...
            modelBuilder.Entity("SurveyorLedger.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            IsSystem = true,
                            Name = "Client",
                            PolicyId = new Guid("00000000-0000-0000-0000-000000000703"),
                            UpdatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Owns an organization: manages its subscription, workspaces, and members.",
                            IsSystem = true,
                            Name = "OrgOwner",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Member of an organization. Workspace access is separate and granted per workspace.",
                            IsSystem = true,
                            Name = "OrgMember",
                            PolicyId = new Guid("00000000-0000-0000-0000-000000000701"),
                            UpdatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
            ...
            modelBuilder.Entity("SurveyorLedger.Data.Entities.RolePermission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            PermissionId = new Guid("00000000-0000-0000-0000-000000000145"),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            PermissionId = new Guid("00000000-0000-0000-0000-000000000146"),
                            RoleId = new Guid("00000000-0000-0000-0000-000000000009")
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            PermissionId = new Guid("00000000-0000-0000-0000-000000000147"),
                            RoleId = new Guid("00000000-0000-0000-0000-000000000009")
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            PermissionId = new Guid("00000000-0000-0000-0000-000000000148"),
                            RoleId = new Guid("00000000-0000-0000-0000-000000000009")
                        },
                        new
                        {
            ...
            modelBuilder.Entity("SurveyorLedger.Data.Entities.OrganizationSubscription", b =>
                {
                    b.HasOne("SurveyorLedger.Data.Entities.Organization", "Organization")
                        ...
                        .HasForeignKey("SurveyorLedger.Data.Entities.OrganizationSubscription", "OrganizationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SurveyorLedger.Data.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("SurveyorLedger.Data.Entities.Person", "VoidedByUser")
                        .WithMany()
